...
public class WatcherExample2 implements Watcher {
    ...
    private static final String CONNECTION_STRING = "192.168.43.132:2181";
    private static final String ZK_PATH = "/node7";
    ...
    public static void main(String[] args) {
        ...
        WatcherExample2 sample = new WatcherExample2();
